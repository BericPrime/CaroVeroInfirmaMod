...
public class SmokestacksPiece extends TemplateStructurePiece {

    public SmokestacksPiece(StructureTemplateManager templateManager,
                            ResourceLocation templateLocation,
                            BlockPos pos,
                            RandomSource random) {
        super(ModStructurePieceTypes.SMOKESTACKS_PIECE.get(), 0, templateManager,
                templateLocation, templateLocation.toString(),
                makeSettings(random), pos);
    }

    public SmokestacksPiece(StructurePieceSerializationContext context, CompoundTag tag) {
        super(ModStructurePieceTypes.SMOKESTACKS_PIECE.get(), tag, context.structureTemplateManager(),
