...
public class SmallRuinStructure extends Structure {
    public static final Codec<SmallRuinStructure> CODEC =
            simpleCodec(SmallRuinStructure::new);
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if(!FlatChecker.isTerrainFlat(context,x,z,surfaceY,5,7))
    ...
    private void generatePieces(StructurePiecesBuilder builder, GenerationContext context, BlockPos pos) {
        ...
        ResourceLocation templateLocation = new ResourceLocation("caroveroinfirma", "small_ruin");

        builder.addPiece(new SmallRuinPiece(
                templateManager,
                templateLocation,
                pos,
                context.random()
    ...
    public StructureType<?> type() {
        return ModStructureTypes.SMALL_RUIN.get();
    }
}